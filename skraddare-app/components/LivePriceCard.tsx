...
const styles = StyleSheet.create({
  ...
  priceLabel: { color: 'rgba(200,230,201,0.55)', letterSpacing: 1.5 },
  breakdown:  {
  ...
  pickup:   { fontFamily: 'DMSans_400', fontSize: 12, color: 'rgba(200,230,201,0.55)' },
  delivery: { fontFamily: 'DMSans_300', fontSize: 9,  color: 'rgba(200,230,201,0.3)', marginTop: 2 },
});
